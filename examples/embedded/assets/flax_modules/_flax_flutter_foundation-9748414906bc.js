...
// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/index.js
var index_exports = {};
__export(index_exports, {
  TargetPlatform: () => TargetPlatform,
  ValueKey: () => ValueKey,
  ValueListenable: () => ValueListenable,
  getDefaultTargetPlatform: () => getDefaultTargetPlatform,
  getKIsWeb: () => getKIsWeb
});
module.exports = __toCommonJS(index_exports);

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_Key.js
...
// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_Listenable.js
var import_bindings3 = require("@flax/core/bindings");
defineObject("flax.core/flutter#type:Listenable", [], [], {
...
// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_LocalKey.js
var import_bindings4 = require("@flax/core/bindings");
defineObject("flax.core/flutter#type:LocalKey", [], [], {}, []);

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_ValueKey.js
...
function ValueKey(value) {
  ...
  return constructObject("object", "flax.core/flutter#type:ValueKey", "", [{ "name": "value", "required": true, "positional": true }], [value], {});
}

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_ValueListenable.js
var import_bindings6 = require("@flax/core/bindings");
var import_bindings7 = require("@flax/core/bindings");
defineObject("flax.core/flutter#type:ValueListenable", ["value"], [], {
  addListener(listener) {
    if (arguments.length > 1)
      throw new TypeError("Too many method arguments");
...
var ValueListenable = class _ValueListenable {
  constructor() {
    (0, import_bindings7.constructExtendedProxy)(this, _ValueListenable.prototype, "flax.core/flutter#type:ValueListenable", [], Array.from(arguments), ["addListener", "removeListener"], ["value"], [], []);
  }
};
(function(ValueListenable2) {
  function implement(args, implementation) {
    return constructProxy("flax.core/flutter#type:ValueListenable", [], args, implementation, ["addListener", "removeListener"], ["value"], []);
  }
  ValueListenable2.implement = implement;
})(ValueListenable || (ValueListenable = {}));

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_TargetPlatform.js
var import_bindings8 = require("@flax/core/bindings");
var TargetPlatform = Object.freeze({
  android: enumValue("flax.core/flutter#type:TargetPlatform", "android"),
  fuchsia: enumValue("flax.core/flutter#type:TargetPlatform", "fuchsia"),
  iOS: enumValue("flax.core/flutter#type:TargetPlatform", "iOS"),
  linux: enumValue("flax.core/flutter#type:TargetPlatform", "linux"),
  macOS: enumValue("flax.core/flutter#type:TargetPlatform", "macOS"),
  windows: enumValue("flax.core/flutter#type:TargetPlatform", "windows")
});

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_defaultTargetPlatform.js
var import_bindings9 = require("@flax/core/bindings");
function getDefaultTargetPlatform() {
  return invokeTopLevel("flax.core/flutter#read:defaultTargetPlatform", []);
}

// ../../../packages/flax/js/dist/flutter/generated/libraries/foundation/_bindings/flutter_kIsWeb.js
var import_bindings10 = require("@flax/core/bindings");
function getKIsWeb() {
  return invokeTopLevel("flax.core/flutter#read:kIsWeb", []);
}
