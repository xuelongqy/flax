...
// ../../../packages/flax/js/dist/dart/generated/libraries/async/index.js
var index_exports = {};
__export(index_exports, {
  ...
  StreamTransformerBase: () => StreamTransformerBase,
  StreamView: () => StreamView
});
module.exports = __toCommonJS(index_exports);

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_EventSink.js
var import_bindings2 = require("@flax/core/bindings");
var import_flutter_Sink = require("@flax/dart/core");
...
(function(EventSink2) {
  function implement(args, implementation) {
    return constructProxy("flax.core/flutter#type:EventSink", [], args, implementation, ["add", "addError", "close"], [], []);
  }
  EventSink2.implement = implement;
})(EventSink || (EventSink = {}));

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_MultiStreamController.js
var import_bindings6 = require("@flax/core/bindings");

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamController.js
var import_bindings5 = require("@flax/core/bindings");

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamSink.js
var import_bindings4 = require("@flax/core/bindings");
var import_flutter_Sink2 = require("@flax/dart/core");

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamConsumer.js
...
(function(StreamConsumer2) {
  function implement(args, implementation) {
    return constructProxy("flax.core/flutter#type:StreamConsumer", [], args, implementation, ["addStream", "close"], [], []);
  }
  StreamConsumer2.implement = implement;
})(StreamConsumer || (StreamConsumer = {}));
...
function StreamController(options = {}) {
  ...
  return constructObject("object", "flax.core/flutter#type:StreamController", "", [{ "name": "onListen", "required": false, "positional": false }, { "name": "onPause", "required": false, "positional": false }, { "name": "onResume", "required": false, "positional": false }, { "name": "onCancel", "required": false, "positional": false }, { "name": "sync", "required": false, "positional": false }], [], options);
}
(function(StreamController2) {
  function broadcast(options = {}) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructObject("object", "flax.core/flutter#type:StreamController", "broadcast", [{ "name": "onListen", "required": false, "positional": false }, { "name": "onCancel", "required": false, "positional": false }, { "name": "sync", "required": false, "positional": false }], [], options);
  }
  StreamController2.broadcast = broadcast;
})(StreamController || (StreamController = {}));
...
// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_Stream.js
var import_bindings9 = require("@flax/core/bindings");
var import_flutter_StackTrace7 = require("@flax/dart/core");
var import_flutter_Duration = require("@flax/dart/core");

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamSubscription.js
...
// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamTransformer.js
...
function StreamTransformer(onListen) {
  if (arguments.length > 1)
    throw new TypeError("Too many constructor arguments");
  return constructObject("object", "flax.core/flutter#type:StreamTransformer", "", [{ "name": "onListen", "required": true, "positional": true }], [onListen], {});
}
(function(StreamTransformer2) {
  function fromHandlers(options = {}) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructObject("object", "flax.core/flutter#type:StreamTransformer", "fromHandlers", [{ "name": "handleData", "required": false, "positional": false }, { "name": "handleError", "required": false, "positional": false }, { "name": "handleDone", "required": false, "positional": false }], [], options);
  }
  StreamTransformer2.fromHandlers = fromHandlers;
})(StreamTransformer || (StreamTransformer = {}));
(function(StreamTransformer2) {
  function fromBind(bind) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructObject("object", "flax.core/flutter#type:StreamTransformer", "fromBind", [{ "name": "bind", "required": true, "positional": true }], [bind], {});
  }
  StreamTransformer2.fromBind = fromBind;
})(StreamTransformer || (StreamTransformer = {}));
(function(StreamTransformer2) {
  function implement(args, implementation) {
    return constructProxy("flax.core/flutter#type:StreamTransformer", [], args, implementation, ["bind", "cast"], [], []);
  }
  StreamTransformer2.implement = implement;
})(StreamTransformer || (StreamTransformer = {}));
(function(StreamTransformer2) {
  function castFrom(source) {
    if (arguments.length > 1)
      throw new TypeError("Too many method arguments");
    const _flaxResult = invokeStatic("flax.core/flutter#type:StreamTransformer", "castFrom", [source]);
    return _flaxResult;
  }
  StreamTransformer2.castFrom = castFrom;
})(StreamTransformer || (StreamTransformer = {}));
...
(function(Stream2) {
  function fromAsyncIterable(source) {
    return constructAsyncIterableStream("flax.core/flutter#type:Stream", source);
  }
  Stream2.fromAsyncIterable = fromAsyncIterable;
})(Stream || (Stream = {}));
(function(Stream2) {
  function empty(options = {}) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "empty", [{ "name": "broadcast", "required": false, "positional": false }], [], options);
  }
  Stream2.empty = empty;
})(Stream || (Stream = {}));
(function(Stream2) {
  function value(value2) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "value", [{ "name": "value", "required": true, "positional": true }], [value2], {});
  }
  Stream2.value = value;
})(Stream || (Stream = {}));
(function(Stream2) {
  function error(error2, stackTrace) {
    if (arguments.length > 2)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "error", [{ "name": "error", "required": true, "positional": true }, { "name": "stackTrace", "required": false, "positional": true }], [error2, stackTrace], {});
  }
  Stream2.error = error;
})(Stream || (Stream = {}));
(function(Stream2) {
  function fromFuture(future) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "fromFuture", [{ "name": "future", "required": true, "positional": true }], [future], {});
  }
  Stream2.fromFuture = fromFuture;
})(Stream || (Stream = {}));
(function(Stream2) {
  function fromFutures(futures) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "fromFutures", [{ "name": "futures", "required": true, "positional": true }], [futures], {});
  }
  Stream2.fromFutures = fromFutures;
})(Stream || (Stream = {}));
(function(Stream2) {
  function fromIterable(elements) {
    if (arguments.length > 1)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "fromIterable", [{ "name": "elements", "required": true, "positional": true }], [elements], {});
  }
  Stream2.fromIterable = fromIterable;
})(Stream || (Stream = {}));
(function(Stream2) {
  function multi(onListen, options = {}) {
    if (arguments.length > 2)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "multi", [{ "name": "onListen", "required": true, "positional": true }, { "name": "isBroadcast", "required": false, "positional": false }], [onListen], options);
  }
  Stream2.multi = multi;
})(Stream || (Stream = {}));
(function(Stream2) {
  function periodic(period, computation) {
    if (arguments.length > 2)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "periodic", [{ "name": "period", "required": true, "positional": true }, { "name": "computation", "required": false, "positional": true }], [period, computation], {});
  }
  Stream2.periodic = periodic;
})(Stream || (Stream = {}));
(function(Stream2) {
  function eventTransformed(source, mapSink) {
    if (arguments.length > 2)
      throw new TypeError("Too many constructor arguments");
    return constructStream("stream", "flax.core/flutter#type:Stream", "eventTransformed", [{ "name": "source", "required": true, "positional": true }, { "name": "mapSink", "required": true, "positional": true }], [source, mapSink], {});
  }
  Stream2.eventTransformed = eventTransformed;
})(Stream || (Stream = {}));
(function(Stream2) {
  function castFrom(source) {
    if (arguments.length > 1)
  ...
  Stream2.castFrom = castFrom;
})(Stream || (Stream = {}));

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamIterator.js
...
function StreamIterator(stream) {
  if (arguments.length > 1)
    throw new TypeError("Too many constructor arguments");
  return constructObject("object", "flax.core/flutter#type:StreamIterator", "", [{ "name": "stream", "required": true, "positional": true }], [stream], {});
}

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamTransformerBase.js
...
(function(StreamTransformerBase2) {
  ...
  StreamTransformerBase2.implement = implement;
})(StreamTransformerBase || (StreamTransformerBase = {}));

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_StreamView.js
...
function StreamView(stream) {
  if (arguments.length > 1)
    throw new TypeError("Too many constructor arguments");
  return constructStream("stream", "flax.core/flutter#type:StreamView", "", [{ "name": "stream", "required": true, "positional": true }], [stream], {});
}

// ../../../packages/flax/js/dist/dart/generated/libraries/async/_bindings/flutter_SynchronousStreamController.js
