...
export function FilledButton(options: { key?: upstream0.Key | null | undefined; onPressed: Bindable<(() => void) | null>; style?: Bindable<upstream1.ButtonStyle | null> | undefined; child: Bindable<Widget | null> }): FilledButton {
...
export function tonal(options: { key?: upstream0.Key | null | undefined; onPressed: Bindable<(() => void) | null>; style?: Bindable<upstream1.ButtonStyle | null> | undefined; child: Bindable<Widget | null> }): FilledButton {
if (arguments.length > 1) throw new TypeError('Too many constructor arguments');
