...
void main() {
  test('maximal TypeRef Parameter and Generic round-trip every field', () {
    ...
    final encodedType = FlaxCodegenManifestV5Codec.encodeTypeRef(type);
    final encodedParameter = FlaxCodegenManifestV5Codec.encodeParameter(
      parameter,
    );
    final encodedGeneric = FlaxCodegenManifestV5Codec.encodeGenericParameter(
      generic,
    );
  ...
  test('Record TypeRef round-trips fields in canonical order', () {
    ...
    final encoded = FlaxCodegenManifestV5Codec.encodeTypeRef(record);
  ...
  test('Manifest 2 through 6 reject Record TypeRefs', () {
    const record = FlaxCodegenTypeRef(
      'record',
      recordFields: [
        FlaxCodegenRecordFieldModel(
    ...
    for (final version in [2, 3, 4, 5, 6]) {
      ...
      expect(
        ...
        isNull,
        reason: 'Manifest $version must not accept Record TypeRefs',
      );
      expect(
        _records(_throwIfAny(diagnostics)),
        containsAll([
          _record(
            '/functions/0/call/parameters/0/type/recordFields',
            'Unknown field.',
          ),
          _record(
            '/functions/0/call/parameters/0/type/kind',
            'Record types require Manifest 7.',
          ),
          _record('/functions/0/call/result/recordFields', 'Unknown field.'),
          _record(
            '/functions/0/call/result/kind',
            'Record types require Manifest 7.',
          ),
        ]),
      );
  ...
  test('malformed objects aggregate stable FCG_MANIFEST diagnostics', () {
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeTypeRef,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeParameter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeGenericParameter,
      '/a~1b/~0tilde',
    );

    final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
    expect(
      FlaxCodegenManifestV5Codec.decodeTypeRef(_malformedType, diagnostics, ''),
      isNull,
    );
    ...
    for (final entry in cases.entries) {
      ...
      try {
        final decoded = FlaxCodegenManifestV5Codec.decodeTypeRef(
          FlaxCodegenManifestV5Codec.encodeTypeRef(entry.value),
          diagnostics,
          '',
        );
  ...
  test('maximal Getter Constructor Method Proxy PageAdapter and RouteCall '
    ...
    final encodedGetter = FlaxCodegenManifestV5Codec.encodeGetter(getter);
    final encodedSetter = FlaxCodegenManifestV5Codec.encodeGetter(setter);
    final encodedConstructor = FlaxCodegenManifestV5Codec.encodeConstructor(
      constructor,
    );
    final encodedMethod = FlaxCodegenManifestV5Codec.encodeMethod(method);
    final encodedProxy = FlaxCodegenManifestV5Codec.encodeProxy(proxy);
    final encodedAdapter = FlaxCodegenManifestV5Codec.encodePageAdapter(
      adapter,
    );
    final encodedRoute = FlaxCodegenManifestV5Codec.encodeRouteCall(route);
  ...
  test('malformed members aggregate stable FCG_MANIFEST diagnostics', () {
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeGetter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeConstructor,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeMethod,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeProxy,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodePageAdapter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeRouteCall,
      '/a~1b/~0tilde',
    );
  ...
  test('maximal Class NamedType Function Snapshot and SnapshotField '
    ...
    final encodedClass = FlaxCodegenManifestV5Codec.encodeClass(type);
    final encodedNamedType = FlaxCodegenManifestV5Codec.encodeNamedType(
      namedType,
    );
    final encodedFunction = FlaxCodegenManifestV5Codec.encodeFunction(function);
    final encodedFunctionWithoutRoute =
        FlaxCodegenManifestV5Codec.encodeFunction(functionWithoutRoute);
    final encodedSnapshot = FlaxCodegenManifestV5Codec.encodeSnapshot(snapshot);
    final encodedSnapshotField = FlaxCodegenManifestV5Codec.encodeSnapshotField(
      snapshotField,
    );
    final encodedEmptySnapshotField =
        FlaxCodegenManifestV5Codec.encodeSnapshotField(emptySnapshotField);
    ...
    final reversed = FlaxCodegenClassModel(
      ...
      widgetGetters: type.widgetGetters,
      jsName: type.jsName,
    );
    expect(
      FlaxCodegenManifestV5Codec.encodeClass(reversed)['listenerPairs'],
  ...
  test('malformed Class NamedType Function Snapshot and SnapshotField '
    ...
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeClass,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeNamedType,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeFunction,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeSnapshot,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeSnapshotField,
      '/a~1b/~0tilde',
    );
    ...
    _expectDecodeError(
      ...
      [
        ...
        _record('/genericScalar', 'Expected a boolean.'),
        _record('/getters/0/encodeKind', 'Missing field.'),
        _record('/getters/0/foo~1bar', 'Unknown field.'),
        _record('/getters/0/name', 'Expected a string.'),
        _record('/getters/0/type', 'Missing field.'),
        ...
        _record('/typeParameters/0/slot', 'Missing slot.'),
        _record('/typeParameters/0/~0x', 'Unknown field.'),
        _record('/widgetGetters/0/encodeKind', 'Missing field.'),
        _record('/widgetGetters/0/foo~1bar', 'Unknown field.'),
        _record('/widgetGetters/0/name', 'Expected a string.'),
        _record('/widgetGetters/0/type', 'Missing field.'),
  ...
  test(
    ...
    () {
      ...
      expect(FlaxCodegenManifestV5Codec.encodeModule(reversed), encoded);
      ...
      final encodedEmpty = FlaxCodegenManifestV5Codec.encodeModule(empty);
  ...
  test('malformed Module aggregates stable FCG_MANIFEST diagnostics', () {
    ...
    final malformedDiagnostics = FlaxCodegenManifestV5Diagnostics(
      'manifest.json',
    );
    expect(
      FlaxCodegenManifestV5Codec.decodeModule(
  ...
  test('invalid live Module semantics fail as FCG_MANIFEST', () {
    ...
    try {
      result = FlaxCodegenManifestV5Codec.decodeModule(
        FlaxCodegenManifestV5Codec.encodeModule(invalid),
        diagnostics,
        '',
        'widgets',
      );
  ...
  group('Manifest2 typeLibraries URI semantics', () {
    ...
    test('rejects every invalid typeLibraries URI with exact FCG_MANIFEST pointers', () {
      ...
      final aggregateDiagnostics = FlaxCodegenManifestV5Diagnostics(
        'manifest.json',
      );
      final aggregateDecoded = FlaxCodegenManifestV5Codec.decodeModule(
        FlaxCodegenManifestV5Codec.encodeModule(_typeLibrariesModule(cases)),
      ...
      for (final entry in cases.entries) {
        ...
        final decoded = FlaxCodegenManifestV5Codec.decodeModule(
          FlaxCodegenManifestV5Codec.encodeModule(
  ...
  test(
    ...
    () {
      ...
      final owned = FlaxCodegenManifestV5Identity(
        sourceIdentity: widgetSource,
        wireId: widgetWire,
        owner: true,
      );
      final referenced = FlaxCodegenManifestV5Identity(
        sourceIdentity: showSource,
        wireId: showWire,
        owner: false,
      );

      final encodedSource = FlaxCodegenManifestV5Codec.encodeSourceIdentity(
        widgetSource,
      );
      final encodedOwned = FlaxCodegenManifestV5Codec.encodeIdentity(owned);
      final encodedReferenced = FlaxCodegenManifestV5Codec.encodeIdentity(
        referenced,
      );
  ...
  test('malformed sourceIdentity and identity aggregate FCG_MANIFEST', () {
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeSourceIdentity,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV5Codec.decodeIdentity,
      '/a~1b/~0tilde',
    );
    _expectDecodeError(
      FlaxCodegenManifestV5Codec.decodeSourceIdentity,
  ...
  group('Manifest 5 envelope positives', () {
    test('fromResolved round-trips rich and zero-entry modules', () {
      ...
      final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
      final parsed = FlaxCodegenManifestV5.parse(
        manifest.encode(),
        diagnostics,
      );
      diagnostics.throwIfAny();
    ...
    test('input permutations encode identically', () {
      ...
      expect(
        FlaxCodegenManifestV5.fromResolved(
      ...
      final collapsed = FlaxCodegenManifestV5.fromResolved(
  ...
  group('Manifest 5 envelope negatives', () {
  ...
  group('Manifest 5 ownership model and fromResolved negatives', () {
      ...
      () {
        ...
        _expectEnvelopeMutation(
          ...
          (json) {
            ...
            parameter['type'] = FlaxCodegenManifestV5Codec.encodeTypeRef(
  ...
  group('Manifest 5 generic lexical slot positives', () {
    ...
    test('projection modulesByModuleId snapshot preserves generic sharing', () {
      ...
      final a = FlaxCodegenManifestV5Projection(
        root: root,
    ...
    test(
      ...
      () {
        ...
        final encoded = FlaxCodegenManifestV5Codec.encodeMethod(method);
    ...
    test(
      ...
      () {
        ...
        final encoded = FlaxCodegenManifestV5Codec.encodeClass(type);
    ...
    test('named-type F-bound generics preserve declaration tokens', () {
      ...
      final encoded = FlaxCodegenManifestV5Codec.encodeNamedType(named);
  ...
  group('Manifest 5 generic lexical slot negatives', () {
  ...
  group('Manifest 5 Quality P1 maximal projection', () {
    test('independently constructed maximal module survives fromResolved encode parse projection and input mutation', () {
      ...
      final flaxManifest = FlaxCodegenManifestV5.fromResolved(
        package: FlaxCodegenResolvedPackage(
          dartPackage: 'flax',
          namespace: flaxNamespace,
          modules: [
      ...
      final flaxProjection = FlaxCodegenManifestV5Projection(
        root: flaxManifest,
      ...
      final inputClasses = <FlaxCodegenClassModel>[
        ...
        FlaxCodegenClassModel(
          ...
          widgetGetters: [FlaxCodegenGetterModel('child', inWidgetNominal)],
      ...
      final expected = FlaxCodegenModuleModel(
        ...
        classes: [
          ...
          FlaxCodegenClassModel(
            ...
            widgetGetters: [FlaxCodegenGetterModel('child', exWidgetNominal)],
            supertypes: const ['Widget'],
            superTypes: [exWidgetNominal],
          ),
          FlaxCodegenClassModel(
      ...
      final leafManifest = FlaxCodegenManifestV5.fromResolved(
        package: FlaxCodegenResolvedPackage(
      ...
      final parseDiagnostics = FlaxCodegenManifestV5Diagnostics(
        'manifest.json',
      );
      final parsed = FlaxCodegenManifestV5.parse(
        canonicalBytes,
      ...
      final leafProjection = FlaxCodegenManifestV5Projection(
        root: parsed,
      ...
      final aManifest = FlaxCodegenManifestV5.fromResolved(
        package: FlaxCodegenResolvedPackage(
          dartPackage: 'pkg_a',
          namespace: aNamespace,
          modules: [
      ...
      final aProjection = FlaxCodegenManifestV5Projection(
        root: aManifest,
      ...
      final beforeBytes = FlaxCodegenManifestV5Codec.encodeModule(loaded);
      final correspondence = <Object, Object>{};
      ...
      expect(
        FlaxCodegenManifestV5Codec.encodeModule(afterMutation),
        beforeBytes,
      );
  ...
  group('Manifest 5 direct dependency projection positives', () {
...
''');
    ...
    test('diamond dedupes C and resists mutation across permutations', () {
      ...
      final reversed = FlaxCodegenManifestV5Projection(
    ...
    test(
      ...
      () {
        ...
        final beforeBytes = FlaxCodegenManifestV5Codec.encodeModule(cProjected);
  ...
  group('Manifest 5 direct dependency projection negatives', () {
    ...
    test('unexpected direct import fails closed', () {
      ...
      final b = _packageB(c);
      final a = _packageA(b);
      final root = FlaxCodegenManifestV5(
    ...
    test('cycle back to the root fails closed', () {
      ...
      final cycleRoot = FlaxCodegenManifestV5(
        package: 'pkg_a',
    ...
    test(
      ...
      () {
        final c = _packageC();
        final cAltProjection = FlaxCodegenManifestV5Projection(
    ...
    test('identical pkg_c bytes from three distinct sources fail closed', () {
      ...
      final cThirdProjection = FlaxCodegenManifestV5Projection(
        root: c.projection.manifest,
        directDependencies: const {},
    ...
    test('duplicate moduleId across packages fails closed', () {
      ...
      final rightManifest = FlaxCodegenManifestV5(
        package: 'pkg_d',
      ...
      final rightProjection = FlaxCodegenManifestV5Projection(
        root: rightManifest,
        directDependencies: const {},
        source: 'package:pkg_d/manifest.json',
      );
...
FlaxCodegenParameterModel _decodeParameter(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeParameter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenGenericParameter _decodeGeneric(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeGenericParameter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenException _throwIfAny(FlaxCodegenManifestV5Diagnostics diagnostics) {
  try {
    diagnostics.throwIfAny();
...
FlaxCodegenGetterModel _decodeGetter(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeGetter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenConstructorModel _decodeConstructor(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeConstructor(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenMethodModel _decodeMethod(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeMethod(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenProxyModel _decodeProxy(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeProxy(json, diagnostics, '');
  diagnostics.throwIfAny();
  expect(decoded, isNotNull);
  return decoded!;
}
...
FlaxCodegenPageAdapterModel _decodePageAdapter(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodePageAdapter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenRouteCallModel _decodeRouteCall(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeRouteCall(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenClassModel _decodeClass(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeClass(json, diagnostics, '');
  diagnostics.throwIfAny();
  expect(decoded, isNotNull);
  return decoded!;
}
...
FlaxCodegenNamedTypeModel _decodeNamedType(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeNamedType(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenFunctionModel _decodeFunction(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeFunction(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenSnapshotModel _decodeSnapshot(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeSnapshot(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenSnapshotFieldModel _decodeSnapshotField(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeSnapshotField(
    json,
    diagnostics,
    '',
  );
...
void _expectClass(
  ...
  expect(actual.genericScalar, expected.genericScalar);
  ...
  expect(actual.widgetGetters, hasLength(expected.widgetGetters.length));
  for (var index = 0; index < expected.widgetGetters.length; index++) {
    _expectGetter(
      actual.widgetGetters[index],
      expected.widgetGetters[index],
      correspondence,
    );
  }
...
void _expectClassJson(Object? json) {
  final object = _expectObject(json);
  _expectExactKeys(object, _classKeys);
  _expectJsonList(object['typeParameters'], _expectGenericJson);
  ...
  _expectJsonList(object['widgetGetters'], _expectGetterJson);
  expect(object['typeArguments'], isA<List<String>>());
...
FlaxCodegenSourceIdentity _decodeSourceIdentity(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeSourceIdentity(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenManifestV5Identity _decodeIdentity(Object? json) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV5Codec.decodeIdentity(
    json,
    diagnostics,
    '',
  );
...
void _expectSourceIdentityFailure(
  ...
  try {
    result = FlaxCodegenManifestV5Codec.decodeSourceIdentity(
      json,
      diagnostics,
      '',
    );
...
void _expectIdentityFailure(Object? json, List<Map<String, String>> records) {
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  FlaxCodegenManifestV5Identity? result;
  try {
    result = FlaxCodegenManifestV5Codec.decodeIdentity(json, diagnostics, '');
    diagnostics.throwIfAny();
...
void _expectEnvelopeShape(
  FlaxCodegenManifestV5 manifest,
  ...
  expect(FlaxCodegenManifestV5.formatVersion, 11);
  expect(FlaxCodegenManifestV5.uiProtocol, 20);
...
void _expectEnvelopeFailure(
  ...
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  FlaxCodegenManifestV5? result;
  try {
    result = FlaxCodegenManifestV5.parse(contents, diagnostics);
  } catch (error) {
    if (error is TestFailure) rethrow;
    fail('leaked ${error.runtimeType}: $error');
  }
...
void _expectFromResolvedFailure({
  ...
  FlaxCodegenManifestV5? result;
  try {
    result = FlaxCodegenManifestV5.fromResolved(
      package: package,
      modules: modules,
...
void _expectEnvelope(
  FlaxCodegenManifestV5 actual,
  FlaxCodegenManifestV5 expected,
) {
...
Map<String, Object?> _slotCallbackJson(FlaxCodegenTypeRef type) =>
    Map<String, Object?>.from(FlaxCodegenManifestV5Codec.encodeTypeRef(type));
...
void _expectSlotDecodeFailure(
  ...
  final diagnostics = FlaxCodegenManifestV5Diagnostics('manifest.json');
  expect(
    FlaxCodegenManifestV5Codec.decodeTypeRef(json, diagnostics, ''),
    isNull,
  );
  expect(_records(_throwIfAny(diagnostics)), records);
}
...
_ProjectionPackage _slotIdMethodProjectionPackage(
  ...
  final manifest = FlaxCodegenManifestV5(
    package: 'pkg_slot',
  ...
  return _ProjectionPackage(
    projection: FlaxCodegenManifestV5Projection(
      root: manifest,
      directDependencies: const {},
...
final class _ProjectionChain {
  ...
  final FlaxCodegenManifestV5Projection aProjection;
...
final class _ProjectionDiamond {
  ...
  final FlaxCodegenManifestV5Projection aProjection;
  final FlaxCodegenManifestV5 aManifest;
  final FlaxCodegenManifestV5Projection bProjection;
  final FlaxCodegenManifestV5Projection dProjection;
  final FlaxCodegenManifestV5Projection cProjection;
  final FlaxCodegenModuleId aModuleId;
  final FlaxCodegenModuleId cModuleId;
}
...
FlaxCodegenManifestV5 _manifestWithIdentities(
  FlaxCodegenManifestV5 base,
  List<FlaxCodegenManifestV5Identity> identities,
) {
  final module = base.modules.single;
  final sorted = List<FlaxCodegenManifestV5Identity>.of(identities)
...
FlaxCodegenManifestV5 _manifestWithModule(
  FlaxCodegenManifestV5 base,
    ...
    modules: [
      FlaxCodegenManifestV5Module(
        ...
        model: FlaxCodegenManifestV5Model(
          ...
          identities: List<FlaxCodegenManifestV5Identity>.of(
...
FlaxCodegenManifestV5 _rootImporting(List<String> imports) {
  final namespace = FlaxCodegenBindingNamespace.parse('com.example.a');
  final moduleId = FlaxCodegenModuleId(
    namespace: namespace,
    name: FlaxCodegenModuleName.parse('app'),
...
FlaxCodegenManifestV5 _projectionDiamondRoot({
...
FlaxCodegenManifestV5 _projectionTripleRoot({
  required _ProjectionPackage b,
  required _ProjectionPackage d,
...
_ProjectionPackage _ownedPackage({
  ...
  Map<String, FlaxCodegenManifestV5Projection> directDependencies = const {},
  ...
  if (allowForeignWire) {
    manifest = FlaxCodegenManifestV5(
      package: dartPackage,
      bindingNamespace: ns,
      imports: imports,
      modules: [
    ...
    manifest = FlaxCodegenManifestV5.fromResolved(
      package: FlaxCodegenResolvedPackage(
