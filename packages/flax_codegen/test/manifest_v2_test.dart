...
import 'package:flax_codegen/src/manifest_v2_projection.dart';
...
void main() {
  test('maximal TypeRef Parameter and Generic round-trip every field', () {
    ...
    final encodedType = FlaxCodegenManifestV2Codec.encodeTypeRef(type);
    final encodedParameter = FlaxCodegenManifestV2Codec.encodeParameter(
      parameter,
    );
    final encodedGeneric = FlaxCodegenManifestV2Codec.encodeGenericParameter(
      generic,
    );
  ...
  test('malformed objects aggregate stable FCG_MANIFEST diagnostics', () {
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeTypeRef,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeParameter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeGenericParameter,
      '/a~1b/~0tilde',
    );

    final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
    expect(
      FlaxCodegenManifestV2Codec.decodeTypeRef(_malformedType, diagnostics, ''),
      isNull,
    );
  ...
  test('invalid TypeRef semantics fail as FCG_MANIFEST', () {
    ...
    for (final entry in cases.entries) {
      final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
      try {
        final decoded = FlaxCodegenManifestV2Codec.decodeTypeRef(
          FlaxCodegenManifestV2Codec.encodeTypeRef(entry.value),
          diagnostics,
          '',
        );
  ...
  test('maximal Getter Constructor Method Proxy PageAdapter and RouteCall '
    ...
    final encodedGetter = FlaxCodegenManifestV2Codec.encodeGetter(getter);
    final encodedSetter = FlaxCodegenManifestV2Codec.encodeGetter(setter);
    final encodedConstructor = FlaxCodegenManifestV2Codec.encodeConstructor(
      constructor,
    );
    final encodedMethod = FlaxCodegenManifestV2Codec.encodeMethod(method);
    final encodedProxy = FlaxCodegenManifestV2Codec.encodeProxy(proxy);
    final encodedAdapter = FlaxCodegenManifestV2Codec.encodePageAdapter(
      adapter,
    );
    final encodedRoute = FlaxCodegenManifestV2Codec.encodeRouteCall(route);
  ...
  test('malformed members aggregate stable FCG_MANIFEST diagnostics', () {
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeGetter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeConstructor,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeMethod,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeProxy,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodePageAdapter,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeRouteCall,
      '/a~1b/~0tilde',
    );
  ...
  test('maximal Class NamedType Function Snapshot and SnapshotField '
    ...
    final encodedClass = FlaxCodegenManifestV2Codec.encodeClass(type);
    final encodedNamedType = FlaxCodegenManifestV2Codec.encodeNamedType(
      namedType,
    );
    final encodedFunction = FlaxCodegenManifestV2Codec.encodeFunction(function);
    final encodedFunctionWithoutRoute =
        FlaxCodegenManifestV2Codec.encodeFunction(functionWithoutRoute);
    final encodedSnapshot = FlaxCodegenManifestV2Codec.encodeSnapshot(snapshot);
    final encodedSnapshotField = FlaxCodegenManifestV2Codec.encodeSnapshotField(
      snapshotField,
    );
    final encodedEmptySnapshotField =
        FlaxCodegenManifestV2Codec.encodeSnapshotField(emptySnapshotField);
    ...
    expect(
      FlaxCodegenManifestV2Codec.encodeClass(reversed)['listenerPairs'],
  ...
  test('malformed Class NamedType Function Snapshot and SnapshotField '
    ...
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeClass,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeNamedType,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeFunction,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeSnapshot,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeSnapshotField,
      '/a~1b/~0tilde',
    );
  ...
  test(
    ...
    () {
      ...
      expect(FlaxCodegenManifestV2Codec.encodeModule(reversed), encoded);
      ...
      final encodedEmpty = FlaxCodegenManifestV2Codec.encodeModule(empty);
  ...
  test('malformed Module aggregates stable FCG_MANIFEST diagnostics', () {
    final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
    expect(
      FlaxCodegenManifestV2Codec.decodeModule(
        'nope',
        diagnostics,
        '/a~1b/~0tilde',
        'widgets',
    ...
    final malformedDiagnostics = FlaxCodegenManifestV2Diagnostics(
      'manifest.json',
    );
    expect(
      FlaxCodegenManifestV2Codec.decodeModule(
  ...
  test('invalid live Module semantics fail as FCG_MANIFEST', () {
    ...
    try {
      result = FlaxCodegenManifestV2Codec.decodeModule(
        FlaxCodegenManifestV2Codec.encodeModule(invalid),
        diagnostics,
        '',
        'widgets',
      );
  ...
  group('Manifest2 typeLibraries URI semantics', () {
    ...
    test('rejects every invalid typeLibraries URI with exact FCG_MANIFEST pointers', () {
      ...
      final aggregateDiagnostics = FlaxCodegenManifestV2Diagnostics(
        'manifest.json',
      );
      final aggregateDecoded = FlaxCodegenManifestV2Codec.decodeModule(
        FlaxCodegenManifestV2Codec.encodeModule(_typeLibrariesModule(cases)),
      ...
      for (final entry in cases.entries) {
        ...
        final decoded = FlaxCodegenManifestV2Codec.decodeModule(
          FlaxCodegenManifestV2Codec.encodeModule(
  ...
  test(
    ...
    () {
      ...
      final owned = FlaxCodegenManifestV2Identity(
        sourceIdentity: widgetSource,
        wireId: widgetWire,
        owner: true,
      );
      final referenced = FlaxCodegenManifestV2Identity(
        sourceIdentity: showSource,
        wireId: showWire,
        owner: false,
      );

      final encodedSource = FlaxCodegenManifestV2Codec.encodeSourceIdentity(
        widgetSource,
      );
      final encodedOwned = FlaxCodegenManifestV2Codec.encodeIdentity(owned);
      final encodedReferenced = FlaxCodegenManifestV2Codec.encodeIdentity(
        referenced,
      );
  ...
  test('malformed sourceIdentity and identity aggregate FCG_MANIFEST', () {
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeSourceIdentity,
      '/a~1b/~0tilde',
    );
    _expectMappingError(
      FlaxCodegenManifestV2Codec.decodeIdentity,
      '/a~1b/~0tilde',
    );
    _expectDecodeError(
      FlaxCodegenManifestV2Codec.decodeSourceIdentity,
  ...
  group('Manifest 2 envelope positives', () {
    test('fromResolved round-trips rich and zero-entry modules', () {
      ...
      final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
      final parsed = FlaxCodegenManifestV2.parse(
        manifest.encode(),
        diagnostics,
      );
      diagnostics.throwIfAny();
    ...
    test('input permutations encode identically', () {
      ...
      expect(
        FlaxCodegenManifestV2.fromResolved(
      ...
      final collapsed = FlaxCodegenManifestV2.fromResolved(
  ...
  group('Manifest 2 envelope negatives', () {
  ...
  group('Manifest 2 ownership model and fromResolved negatives', () {
  ...
  group('Manifest 2 generic lexical slot positives', () {
    ...
    test('projection modulesByModuleId snapshot preserves generic sharing', () {
      ...
      final a = FlaxCodegenManifestV2Projection(
        root: root,
    ...
    test(
      ...
      () {
        ...
        final encoded = FlaxCodegenManifestV2Codec.encodeMethod(method);
    ...
    test(
      ...
      () {
        ...
        final encoded = FlaxCodegenManifestV2Codec.encodeClass(type);
    ...
    test('named-type F-bound generics preserve declaration tokens', () {
      ...
      final encoded = FlaxCodegenManifestV2Codec.encodeNamedType(named);
  ...
  group('Manifest 2 generic lexical slot negatives', () {
  ...
  group('Manifest 2 Quality P1 maximal projection', () {
    test('independently constructed maximal module survives fromResolved encode parse projection and input mutation', () {
      ...
      final flaxManifest = FlaxCodegenManifestV2.fromResolved(
        package: FlaxCodegenResolvedPackage(
          dartPackage: 'flax',
          namespace: flaxNamespace,
          modules: [
      ...
      final flaxProjection = FlaxCodegenManifestV2Projection(
        root: flaxManifest,
      ...
      final leafManifest = FlaxCodegenManifestV2.fromResolved(
        package: FlaxCodegenResolvedPackage(
      ...
      final parseDiagnostics = FlaxCodegenManifestV2Diagnostics(
        'manifest.json',
      );
      final parsed = FlaxCodegenManifestV2.parse(
        canonicalBytes,
      ...
      final leafProjection = FlaxCodegenManifestV2Projection(
        root: parsed,
      ...
      final aManifest = FlaxCodegenManifestV2.fromResolved(
        package: FlaxCodegenResolvedPackage(
          dartPackage: 'pkg_a',
          namespace: aNamespace,
          modules: [
      ...
      final aProjection = FlaxCodegenManifestV2Projection(
        root: aManifest,
      ...
      final beforeBytes = FlaxCodegenManifestV2Codec.encodeModule(loaded);
      final correspondence = <Object, Object>{};
      ...
      expect(
        FlaxCodegenManifestV2Codec.encodeModule(afterMutation),
        beforeBytes,
      );
  ...
  group('Manifest 2 direct dependency projection positives', () {
...
''');
    ...
    test('diamond dedupes C and resists mutation across permutations', () {
      ...
      final reversed = FlaxCodegenManifestV2Projection(
    ...
    test(
      ...
      () {
        ...
        final beforeBytes = FlaxCodegenManifestV2Codec.encodeModule(cProjected);
  ...
  group('Manifest 2 direct dependency projection negatives', () {
    ...
    test('unexpected direct import fails closed', () {
      ...
      final b = _packageB(c);
      final a = _packageA(b);
      final root = FlaxCodegenManifestV2(
    ...
    test('cycle back to the root fails closed', () {
      ...
      final cycleRoot = FlaxCodegenManifestV2(
        package: 'pkg_a',
    ...
    test(
      ...
      () {
        final c = _packageC();
        final cAltProjection = FlaxCodegenManifestV2Projection(
    ...
    test('identical pkg_c bytes from three distinct sources fail closed', () {
      ...
      final cThirdProjection = FlaxCodegenManifestV2Projection(
        root: c.projection.manifest,
        directDependencies: const {},
    ...
    test('duplicate moduleId across packages fails closed', () {
      ...
      final rightManifest = FlaxCodegenManifestV2(
        package: 'pkg_d',
      ...
      final rightProjection = FlaxCodegenManifestV2Projection(
        root: rightManifest,
        directDependencies: const {},
        source: 'package:pkg_d/manifest.json',
      );
...
FlaxCodegenParameterModel _decodeParameter(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeParameter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenGenericParameter _decodeGeneric(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeGenericParameter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenException _throwIfAny(FlaxCodegenManifestV2Diagnostics diagnostics) {
  try {
    diagnostics.throwIfAny();
...
void _expectTypeJson(Object? json) {
  ...
  expect(object.keys.toSet(), _typeKeys);
...
FlaxCodegenGetterModel _decodeGetter(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeGetter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenConstructorModel _decodeConstructor(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeConstructor(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenMethodModel _decodeMethod(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeMethod(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenProxyModel _decodeProxy(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeProxy(json, diagnostics, '');
  diagnostics.throwIfAny();
  expect(decoded, isNotNull);
  return decoded!;
}
...
FlaxCodegenPageAdapterModel _decodePageAdapter(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodePageAdapter(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenRouteCallModel _decodeRouteCall(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeRouteCall(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenClassModel _decodeClass(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeClass(json, diagnostics, '');
  diagnostics.throwIfAny();
  expect(decoded, isNotNull);
  return decoded!;
}
...
FlaxCodegenNamedTypeModel _decodeNamedType(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeNamedType(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenFunctionModel _decodeFunction(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeFunction(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenSnapshotModel _decodeSnapshot(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeSnapshot(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenSnapshotFieldModel _decodeSnapshotField(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeSnapshotField(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenSourceIdentity _decodeSourceIdentity(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeSourceIdentity(
    json,
    diagnostics,
    '',
  );
...
FlaxCodegenManifestV2Identity _decodeIdentity(Object? json) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  final decoded = FlaxCodegenManifestV2Codec.decodeIdentity(
    json,
    diagnostics,
    '',
  );
...
void _expectSourceIdentityFailure(
  ...
  try {
    result = FlaxCodegenManifestV2Codec.decodeSourceIdentity(
      json,
      diagnostics,
      '',
    );
...
void _expectIdentityFailure(Object? json, List<Map<String, String>> records) {
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  FlaxCodegenManifestV2Identity? result;
  try {
    result = FlaxCodegenManifestV2Codec.decodeIdentity(json, diagnostics, '');
    diagnostics.throwIfAny();
...
void _expectEnvelopeShape(
  FlaxCodegenManifestV2 manifest,
  ...
  expect(FlaxCodegenManifestV2.formatVersion, 2);
  expect(FlaxCodegenManifestV2.uiProtocol, 20);
...
void _expectEnvelopeFailure(
  ...
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  FlaxCodegenManifestV2? result;
  try {
    result = FlaxCodegenManifestV2.parse(contents, diagnostics);
  } catch (error) {
    if (error is TestFailure) rethrow;
    fail('leaked ${error.runtimeType}: $error');
  }
...
void _expectFromResolvedFailure({
  ...
  FlaxCodegenManifestV2? result;
  try {
    result = FlaxCodegenManifestV2.fromResolved(
      package: package,
      modules: modules,
...
void _expectEnvelope(
  FlaxCodegenManifestV2 actual,
  FlaxCodegenManifestV2 expected,
) {
...
Map<String, Object?> _slotCallbackJson(FlaxCodegenTypeRef type) =>
    Map<String, Object?>.from(FlaxCodegenManifestV2Codec.encodeTypeRef(type));
...
void _expectSlotDecodeFailure(
  ...
  final diagnostics = FlaxCodegenManifestV2Diagnostics('manifest.json');
  expect(
    FlaxCodegenManifestV2Codec.decodeTypeRef(json, diagnostics, ''),
    isNull,
  );
  expect(_records(_throwIfAny(diagnostics)), records);
}
...
_ProjectionPackage _slotIdMethodProjectionPackage(
  ...
  final manifest = FlaxCodegenManifestV2(
    package: 'pkg_slot',
  ...
  return _ProjectionPackage(
    projection: FlaxCodegenManifestV2Projection(
      root: manifest,
      directDependencies: const {},
...
final class _ProjectionChain {
  ...
  final FlaxCodegenManifestV2Projection aProjection;
...
final class _ProjectionDiamond {
  ...
  final FlaxCodegenManifestV2Projection aProjection;
  final FlaxCodegenManifestV2 aManifest;
  final FlaxCodegenManifestV2Projection bProjection;
  final FlaxCodegenManifestV2Projection dProjection;
  final FlaxCodegenManifestV2Projection cProjection;
  final FlaxCodegenModuleId aModuleId;
  final FlaxCodegenModuleId cModuleId;
}
...
void _expectProjectionFailure({
  required FlaxCodegenManifestV2 root,
...
FlaxCodegenManifestV2 _manifestWithIdentities(
  FlaxCodegenManifestV2 base,
  List<FlaxCodegenManifestV2Identity> identities,
) {
  final module = base.modules.single;
  final sorted = List<FlaxCodegenManifestV2Identity>.of(identities)
...
FlaxCodegenManifestV2 _manifestWithModule(
  FlaxCodegenManifestV2 base,
    ...
    modules: [
      FlaxCodegenManifestV2Module(
        ...
        model: FlaxCodegenManifestV2Model(
          ...
          identities: List<FlaxCodegenManifestV2Identity>.of(
...
FlaxCodegenManifestV2 _rootImporting(List<String> imports) {
  final namespace = FlaxCodegenBindingNamespace.parse('com.example.a');
  final moduleId = FlaxCodegenModuleId(
    namespace: namespace,
    name: FlaxCodegenModuleName.parse('app'),
...
FlaxCodegenManifestV2 _projectionDiamondRoot({
...
FlaxCodegenManifestV2 _projectionTripleRoot({
  required _ProjectionPackage b,
  required _ProjectionPackage d,
...
_ProjectionPackage _ownedPackage({
  ...
  Map<String, FlaxCodegenManifestV2Projection> directDependencies = const {},
  ...
  if (allowForeignWire) {
    manifest = FlaxCodegenManifestV2(
      package: dartPackage,
      bindingNamespace: ns,
      imports: imports,
      modules: [
    ...
    manifest = FlaxCodegenManifestV2.fromResolved(
      package: FlaxCodegenResolvedPackage(
