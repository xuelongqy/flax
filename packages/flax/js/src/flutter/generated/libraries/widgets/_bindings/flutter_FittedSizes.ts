...
export interface FittedSizes extends Readonly<{ "__flaxBound:package:flutter/src/painting/box_fit.dart::FittedSizes": readonly [] }> { readonly __FittedSizes: unique symbol;
