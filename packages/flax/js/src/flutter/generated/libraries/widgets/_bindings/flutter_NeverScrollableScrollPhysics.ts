...
export interface NeverScrollableScrollPhysics extends upstream0.ScrollPhysics, Readonly<{ "__flaxBound:package:flutter/src/widgets/scroll_physics.dart::NeverScrollableScrollPhysics": readonly [] }> { readonly __NeverScrollableScrollPhysics: unique symbol;
