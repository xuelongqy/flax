...
export interface OutlinedBorder extends upstream0.ShapeBorder, Readonly<{ "__flaxBound:package:flutter/src/painting/borders.dart::OutlinedBorder": readonly [] }> { readonly __OutlinedBorder: unique symbol;
