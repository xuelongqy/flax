...
export interface RouteSettings extends Readonly<{ "__flaxBound:package:flutter/src/widgets/navigator.dart::RouteSettings": readonly [] }> { readonly __RouteSettings: unique symbol;
