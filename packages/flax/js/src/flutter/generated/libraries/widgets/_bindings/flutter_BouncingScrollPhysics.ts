...
export interface BouncingScrollPhysics extends upstream0.ScrollPhysics, Readonly<{ "__flaxBound:package:flutter/src/widgets/scroll_physics.dart::BouncingScrollPhysics": readonly [] }> { readonly __BouncingScrollPhysics: unique symbol;
