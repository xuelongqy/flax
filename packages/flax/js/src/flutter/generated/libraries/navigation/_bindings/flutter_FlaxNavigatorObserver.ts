...
export interface FlaxNavigatorObserver extends upstream0.NavigatorObserver, Readonly<{ "__flaxBound:package:flax/bindings.dart::FlaxNavigatorObserver": readonly [] }> { readonly __FlaxNavigatorObserver: unique symbol;
}
